...
## Overview
This project demonstrates a production-style AWS Virtual Private Cloud (VPC) design with segmented public and private subnets, 
controlled internet access, and clear traffic flow using native AWS networking components.
...
Resources were verified and later torn down to manage costs.
